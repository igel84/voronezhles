...
set :scm, :git
set :repository,  "ssh://git@github.com:igel84/voronezhles.git"

set :user, "hosting_igel84"
set :use_sudo, false
set :deploy_to, "/home/hosting_igel84/projects/voronezhles"
...
set :unicorn_conf, "/etc/unicorn/voronezhles.igel84.rb"
set :unicorn_pid, "/var/run/unicorn/voronezhles.igel84.pid"
